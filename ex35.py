...
def gold_room():
    ...
    if "0" in choice or "1" in choice:
        how_much = int(choice) #converts the string input to an integer and assigns it to a variable
    else:
...
def cthulhu_room():
    ...
    print "He, it, stares and you and you go insane"
